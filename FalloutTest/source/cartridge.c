...
{
	.copyright 		= "g GCE 2125\x80",	// change year if neccessary, do not change "g GCE"
	.music 			= &Vec_Music_d,		// taken from included headers
	.title_height 	= -8,
	.title_width 	= 80,
	.title_y 		= -16,
	.title_x 		= -72,
	.title 			= "COMPUTER CONSOLE\x80"	// note that \x00 is automatically appended!
};
