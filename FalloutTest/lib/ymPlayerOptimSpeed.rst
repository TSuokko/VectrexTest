   ...
   6287                      81 _reg_max_data: 
   6287 08 04 08 04 08 04    82                     .byte       8,4,8,4,8,4,5,6,5,5,5,8,8,5,8,8 
        05 06 05 05 05 08
        08 05 08 08
                             83  .globl rleEncodedData
   6297                      84 rleEncodedData: 
   ...
   6298 4C            [ 2]   91                     inca     
                             ...
                             93 ;;;;;;;;;;;; GET_BIT_START
   6299 E6 42         [ 5]   94                     ldb      BIT_POS,u 
   629B 26 0C         [ 3]   95                     bne      bit_is_ready1 
                             96 ; load a new byte
   629D AE 40         [ 6]   97                     ldx      BYTE_POS,u 
   629F E6 80         [ 6]   98                     ldb      ,x+ 
   62A1 E7 43         [ 5]   99                     stb      CURRENT_DATA_BYTE,u 
   62A3 AF 40         [ 6]  100                     stx      BYTE_POS,u 
   62A5 C6 80         [ 2]  101                     ldb      #0x80 
   62A7 E7 42         [ 5]  102                     stb      BIT_POS,u 
                            103  .globl bit_is_ready1
   62A9                     104 bit_is_ready1: 
                            105 ; bit position correct here
                            106 ;
                            107 ; remember we use one bit now!
   62A9 64 42         [ 7]  108                     lsr      BIT_POS,u 
                            109 ; is the bit at the current position set?
   62AB E4 43         [ 5]  110                     andb     CURRENT_DATA_BYTE,u 
                            111 ;;;;;;;;;;;; GET_BIT_END
   62AD 26 E9         [ 3]  112                     bne      moreBits 
   62AF 1E 89         [ 8]  113                     exg      a,b 
   62B1 1F 02         [ 6]  114                     tfr      d,y                          ; in y now our count of bits 
   ...
   62B3 4F            [ 2]  119                     clra     
                            ...
                            121 ;;;;;;;;;;;; GET_BIT_START
   62B4 E6 42         [ 5]  122                     ldb      BIT_POS,u 
   62B6 26 0C         [ 3]  123                     bne      bit_is_ready2 
                            124 ; load a new byte
   62B8 AE 40         [ 6]  125                     ldx      BYTE_POS,u 
   62BA E6 80         [ 6]  126                     ldb      ,x+ 
   62BC E7 43         [ 5]  127                     stb      CURRENT_DATA_BYTE,u 
   62BE AF 40         [ 6]  128                     stx      BYTE_POS,u 
   62C0 C6 80         [ 2]  129                     ldb      #0x80 
   62C2 E7 42         [ 5]  130                     stb      BIT_POS,u 
                            131  .globl bit_is_ready2
   62C4                     132 bit_is_ready2: 
                            133 ; bit position correct here
                            134 ;
                            135 ; remember we use one bit now!
   62C4 64 42         [ 7]  136                     lsr      BIT_POS,u 
                            137 ; is the bit at the current position set?
   62C6 E4 43         [ 5]  138                     andb     CURRENT_DATA_BYTE,u 
                            139 ;;;;;;;;;;;; GET_BIT_END
   62C8 27 01         [ 3]  140                     beq      rleCounterBit0NotSet 
   62CA 4C            [ 2]  141                     inca     
                            142  .globl rleCounterBit0NotSet
   62CB                     143 rleCounterBit0NotSet: 
   62CB 48            [ 2]  144                     lsla     
                            145 ; macro call ->                     read_one_bit_from_data  
                            146 ;;;;;;;;;;;; GET_BIT_START
   62CC E6 42         [ 5]  147                     ldb      BIT_POS,u 
   62CE 26 0C         [ 3]  148                     bne      bit_is_ready3 
                            149 ; load a new byte
   62D0 AE 40         [ 6]  150                     ldx      BYTE_POS,u 
   62D2 E6 80         [ 6]  151                     ldb      ,x+ 
   62D4 E7 43         [ 5]  152                     stb      CURRENT_DATA_BYTE,u 
   62D6 AF 40         [ 6]  153                     stx      BYTE_POS,u 
   62D8 C6 80         [ 2]  154                     ldb      #0x80 
   62DA E7 42         [ 5]  155                     stb      BIT_POS,u 
                            156  .globl bit_is_ready3
   62DC                     157 bit_is_ready3: 
                            158 ; bit position correct here
                            159 ;
                            160 ; remember we use one bit now!
   62DC 64 42         [ 7]  161                     lsr      BIT_POS,u 
                            162 ; is the bit at the current position set?
   62DE E4 43         [ 5]  163                     andb     CURRENT_DATA_BYTE,u 
                            164 ;;;;;;;;;;;; GET_BIT_END
   62E0 27 01         [ 3]  165                     beq      rleCounterBit1NotSet 
   62E2 4C            [ 2]  166                     inca     
                            167  .globl rleCounterBit1NotSet
   62E3                     168 rleCounterBit1NotSet: 
   62E3 48            [ 2]  169                     lsla     
                            170 ; macro call ->                     read_one_bit_from_data  
                            171 ;;;;;;;;;;;; GET_BIT_START
   62E4 E6 42         [ 5]  172                     ldb      BIT_POS,u 
   62E6 26 0C         [ 3]  173                     bne      bit_is_ready4 
                            174 ; load a new byte
   62E8 AE 40         [ 6]  175                     ldx      BYTE_POS,u 
   62EA E6 80         [ 6]  176                     ldb      ,x+ 
   62EC E7 43         [ 5]  177                     stb      CURRENT_DATA_BYTE,u 
   62EE AF 40         [ 6]  178                     stx      BYTE_POS,u 
   62F0 C6 80         [ 2]  179                     ldb      #0x80 
   62F2 E7 42         [ 5]  180                     stb      BIT_POS,u 
                            181  .globl bit_is_ready4
   62F4                     182 bit_is_ready4: 
                            183 ; bit position correct here
                            184 ;
                            185 ; remember we use one bit now!
   62F4 64 42         [ 7]  186                     lsr      BIT_POS,u 
                            187 ; is the bit at the current position set?
   62F6 E4 43         [ 5]  188                     andb     CURRENT_DATA_BYTE,u 
                            189 ;;;;;;;;;;;; GET_BIT_END
   62F8 27 01         [ 3]  190                     beq      rleCounterBit2NotSet 
   62FA 4C            [ 2]  191                     inca     
                            192  .globl rleCounterBit2NotSet
   62FB                     193 rleCounterBit2NotSet: 
   62FB 31 3F         [ 5]  194                     leay     -1,y 
   62FD 10 27 00 B8   [ 6]  195                     lbeq     rle8bitdone 
   6301 48            [ 2]  196                     lsla     
                            197 ; macro call ->                     read_one_bit_from_data  
                            198 ;;;;;;;;;;;; GET_BIT_START
   6302 E6 42         [ 5]  199                     ldb      BIT_POS,u 
   6304 26 0C         [ 3]  200                     bne      bit_is_ready5 
                            201 ; load a new byte
   6306 AE 40         [ 6]  202                     ldx      BYTE_POS,u 
   6308 E6 80         [ 6]  203                     ldb      ,x+ 
   630A E7 43         [ 5]  204                     stb      CURRENT_DATA_BYTE,u 
   630C AF 40         [ 6]  205                     stx      BYTE_POS,u 
   630E C6 80         [ 2]  206                     ldb      #0x80 
   6310 E7 42         [ 5]  207                     stb      BIT_POS,u 
                            208  .globl bit_is_ready5
   6312                     209 bit_is_ready5: 
                            210 ; bit position correct here
                            211 ;
                            212 ; remember we use one bit now!
   6312 64 42         [ 7]  213                     lsr      BIT_POS,u 
                            214 ; is the bit at the current position set?
   6314 E4 43         [ 5]  215                     andb     CURRENT_DATA_BYTE,u 
                            216 ;;;;;;;;;;;; GET_BIT_END
   6316 27 01         [ 3]  217                     beq      rleCounterBit3NotSet 
   6318 4C            [ 2]  218                     inca     
                            219  .globl rleCounterBit3NotSet
   6319                     220 rleCounterBit3NotSet: 
   6319 31 3F         [ 5]  221                     leay     -1,y 
   631B 10 27 00 9A   [ 6]  222                     lbeq     rle8bitdone 
   631F 48            [ 2]  223                     lsla     
                            224 ; macro call ->                     read_one_bit_from_data  
                            225 ;;;;;;;;;;;; GET_BIT_START
   6320 E6 42         [ 5]  226                     ldb      BIT_POS,u 
   6322 26 0C         [ 3]  227                     bne      bit_is_ready6 
                            228 ; load a new byte
   6324 AE 40         [ 6]  229                     ldx      BYTE_POS,u 
   6326 E6 80         [ 6]  230                     ldb      ,x+ 
   6328 E7 43         [ 5]  231                     stb      CURRENT_DATA_BYTE,u 
   632A AF 40         [ 6]  232                     stx      BYTE_POS,u 
   632C C6 80         [ 2]  233                     ldb      #0x80 
   632E E7 42         [ 5]  234                     stb      BIT_POS,u 
                            235  .globl bit_is_ready6
   6330                     236 bit_is_ready6: 
                            237 ; bit position correct here
                            238 ;
                            239 ; remember we use one bit now!
   6330 64 42         [ 7]  240                     lsr      BIT_POS,u 
                            241 ; is the bit at the current position set?
   6332 E4 43         [ 5]  242                     andb     CURRENT_DATA_BYTE,u 
                            243 ;;;;;;;;;;;; GET_BIT_END
   6334 27 01         [ 3]  244                     beq      rleCounterBit4NotSet 
   6336 4C            [ 2]  245                     inca     
                            246  .globl rleCounterBit4NotSet
   6337                     247 rleCounterBit4NotSet: 
   6337 31 3F         [ 5]  248                     leay     -1,y 
   6339 27 7E         [ 3]  249                     beq      rle8bitdone 
   633B 48            [ 2]  250                     lsla     
                            251 ; macro call ->                     read_one_bit_from_data  
                            252 ;;;;;;;;;;;; GET_BIT_START
   633C E6 42         [ 5]  253                     ldb      BIT_POS,u 
   633E 26 0C         [ 3]  254                     bne      bit_is_ready7 
                            255 ; load a new byte
   6340 AE 40         [ 6]  256                     ldx      BYTE_POS,u 
   6342 E6 80         [ 6]  257                     ldb      ,x+ 
   6344 E7 43         [ 5]  258                     stb      CURRENT_DATA_BYTE,u 
   6346 AF 40         [ 6]  259                     stx      BYTE_POS,u 
   6348 C6 80         [ 2]  260                     ldb      #0x80 
   634A E7 42         [ 5]  261                     stb      BIT_POS,u 
                            262  .globl bit_is_ready7
   634C                     263 bit_is_ready7: 
                            264 ; bit position correct here
                            265 ;
                            266 ; remember we use one bit now!
   634C 64 42         [ 7]  267                     lsr      BIT_POS,u 
                            268 ; is the bit at the current position set?
   634E E4 43         [ 5]  269                     andb     CURRENT_DATA_BYTE,u 
                            270 ;;;;;;;;;;;; GET_BIT_END
   6350 27 01         [ 3]  271                     beq      rleCounterBit5NotSet 
   6352 4C            [ 2]  272                     inca     
                            273  .globl rleCounterBit5NotSet
   6353                     274 rleCounterBit5NotSet: 
   6353 31 3F         [ 5]  275                     leay     -1,y 
   6355 27 62         [ 3]  276                     beq      rle8bitdone 
   6357 48            [ 2]  277                     lsla     
                            278 ; macro call ->                     read_one_bit_from_data  
                            279 ;;;;;;;;;;;; GET_BIT_START
   6358 E6 42         [ 5]  280                     ldb      BIT_POS,u 
   635A 26 0C         [ 3]  281                     bne      bit_is_ready8 
                            282 ; load a new byte
   635C AE 40         [ 6]  283                     ldx      BYTE_POS,u 
   635E E6 80         [ 6]  284                     ldb      ,x+ 
   6360 E7 43         [ 5]  285                     stb      CURRENT_DATA_BYTE,u 
   6362 AF 40         [ 6]  286                     stx      BYTE_POS,u 
   6364 C6 80         [ 2]  287                     ldb      #0x80 
   6366 E7 42         [ 5]  288                     stb      BIT_POS,u 
                            289  .globl bit_is_ready8
   6368                     290 bit_is_ready8: 
                            291 ; bit position correct here
                            292 ;
                            293 ; remember we use one bit now!
   6368 64 42         [ 7]  294                     lsr      BIT_POS,u 
                            295 ; is the bit at the current position set?
   636A E4 43         [ 5]  296                     andb     CURRENT_DATA_BYTE,u 
                            297 ;;;;;;;;;;;; GET_BIT_END
   636C 27 01         [ 3]  298                     beq      rleCounterBit6NotSet 
   636E 4C            [ 2]  299                     inca     
                            300  .globl rleCounterBit6NotSet
   636F                     301 rleCounterBit6NotSet: 
   636F 31 3F         [ 5]  302                     leay     -1,y 
   6371 27 46         [ 3]  303                     beq      rle8bitdone 
   6373 48            [ 2]  304                     lsla     
                            305 ; macro call ->                     read_one_bit_from_data  
                            306 ;;;;;;;;;;;; GET_BIT_START
   6374 E6 42         [ 5]  307                     ldb      BIT_POS,u 
   6376 26 0C         [ 3]  308                     bne      bit_is_ready9 
                            309 ; load a new byte
   6378 AE 40         [ 6]  310                     ldx      BYTE_POS,u 
   637A E6 80         [ 6]  311                     ldb      ,x+ 
   637C E7 43         [ 5]  312                     stb      CURRENT_DATA_BYTE,u 
   637E AF 40         [ 6]  313                     stx      BYTE_POS,u 
   6380 C6 80         [ 2]  314                     ldb      #0x80 
   6382 E7 42         [ 5]  315                     stb      BIT_POS,u 
                            316  .globl bit_is_ready9
   6384                     317 bit_is_ready9: 
                            318 ; bit position correct here
                            319 ;
                            320 ; remember we use one bit now!
   6384 64 42         [ 7]  321                     lsr      BIT_POS,u 
                            322 ; is the bit at the current position set?
   6386 E4 43         [ 5]  323                     andb     CURRENT_DATA_BYTE,u 
                            324 ;;;;;;;;;;;; GET_BIT_END
   6388 27 01         [ 3]  325                     beq      rleCounterBit7NotSet 
   638A 4C            [ 2]  326                     inca     
                            327  .globl rleCounterBit7NotSet
   638B                     328 rleCounterBit7NotSet: 
   638B 31 3F         [ 5]  329                     leay     -1,y 
   638D 27 2A         [ 3]  330                     beq      rle8bitdone 
                            331 ; now the counter has more than 8 bit, gets trickier
   638F A7 46         [ 5]  332                     sta      CURRENT_RLE_COUNTER+1,u      ; assuming high byte is zero of counter 
                            333  .globl read16bitContinue
   6391                     334 read16bitContinue: 
   6391 EC 45         [ 6]  335                     ldd      CURRENT_RLE_COUNTER,u 
                            336 ; this does a LSLD
   6393 48            [ 2]  337                     lsla                                  ; LSL A 
   6394 58            [ 2]  338                     lslb                                  ; LSL B 
   6395 24 02         [ 3]  339                     bcc      no_carry                     ; if no carry, than exit 
   6397 8A 01         [ 2]  340                     ora      #1                           ; otherwise overflow from B to 0bit of A 
                            341  .globl no_carry
   6399                     342 no_carry: 
                            343 ; LSLD finish
   6399 ED 45         [ 6]  344                     std      CURRENT_RLE_COUNTER,u 
                            345 ; macro call ->                     read_one_bit_from_data  
                            346 ;;;;;;;;;;;; GET_BIT_START
   639B E6 42         [ 5]  347                     ldb      BIT_POS,u 
   639D 26 0C         [ 3]  348                     bne      bit_is_ready10 
                            349 ; load a new byte
   639F AE 40         [ 6]  350                     ldx      BYTE_POS,u 
   63A1 E6 80         [ 6]  351                     ldb      ,x+ 
   63A3 E7 43         [ 5]  352                     stb      CURRENT_DATA_BYTE,u 
   63A5 AF 40         [ 6]  353                     stx      BYTE_POS,u 
   63A7 C6 80         [ 2]  354                     ldb      #0x80 
   63A9 E7 42         [ 5]  355                     stb      BIT_POS,u 
                            356  .globl bit_is_ready10
   63AB                     357 bit_is_ready10: 
                            358 ; bit position correct here
                            359 ;
                            360 ; remember we use one bit now!
   63AB 64 42         [ 7]  361                     lsr      BIT_POS,u 
                            362 ; is the bit at the current position set?
   63AD E4 43         [ 5]  363                     andb     CURRENT_DATA_BYTE,u 
                            364 ;;;;;;;;;;;; GET_BIT_END
   63AF 27 02         [ 3]  365                     beq      rleCounterBitXNotSet 
   63B1 6C 46         [ 7]  366                     inc      CURRENT_RLE_COUNTER+1,u 
                            367  .globl rleCounterBitXNotSet
   63B3                     368 rleCounterBitXNotSet: 
   63B3 31 3F         [ 5]  369                     leay     -1,y 
   63B5 26 DA         [ 3]  370                     bne      read16bitContinue 
                            371  .globl rle16bitdone
   63B7                     372 rle16bitdone: 
                            373 ; now the current counter should be set
                            374 ; we still need to dechifer the following byte...
   63B7 20 7C         [ 3]  375                     bra      dechifer 
                            376 
                            377  .globl rle8bitdone
   63B9                     378 rle8bitdone: 
   63B9 A7 46         [ 5]  379                     sta      CURRENT_RLE_COUNTER+1,u      ; assuming high byte is zero of counter 
                            380 ; now the current counter should be set
                            381 ; we still need to dechifer the following byte...
   63BB 20 78         [ 3]  382                     bra      dechifer 
                            383 
                            384 ;***************************************************************************
                            385 ;***************************************************************************
                            386  .globl do_ym_sound
   63BD                     387 do_ym_sound: 
   63BD FC C8 9B      [ 6]  388                     ldd      _ym_data_current              ; load current VBL Counter 
   63C0 27 58         [ 3]  389                     beq      ymsodone                     ; if 0, than we are done 
   63C2 83 00 01      [ 4]  390                     subd     #1                           ; otherwise remember we are doing one byte now 
   63C5 FD C8 9B      [ 6]  391                     std      _ym_data_current              ; and store it 
   63C8 B6 C8 9F      [ 5]  392                     lda      _ym_regs_used                 ; get the number of regs we are working on 
   63CB B7 C8 A0      [ 5]  393                     sta      _ym_regs_count                ; and remember them as current counter 
   63CE CE C8 A1      [ 3]  394                     ldu      #_ym_data_start               ; load RAM start address of our wokring structure 
                            395  .globl next_reg
   63D1                     396 next_reg: 
   ...
   63D1                     402 getCurrentRegByte: 
                            403 ; do we have a byte that is valid?
   63D1 EC 45         [ 6]  404                     ldd      CURRENT_RLE_COUNTER,u        ; if current RLE counter is zero, than we must get a new byte 
   63D3 27 46         [ 3]  405                     beq      noValidByte                  ; jump to get new byte 
                            406 ; yep... use current byte
   63D5 AE 49         [ 6]  407                     ldx      CURRENT_IS_PHRASE,u          ; otherwise, lets check if we are in a phrase (x = pointer to phrase or zero) 
   63D7 27 12         [ 3]  408                     beq      not_in_phrase                ; jump if not 
   63D9 E6 4B         [ 5]  409                     ldb      CURRENT_PLACE_IN_PHRASE,u    ; where in our phrase are we? 
   63DB A6 4F         [ 5]  410                     lda      CURRENT_PHRASE_LEN,u         ; length of phrase 
                            411  .globl inPhraseOut
   63DD                     412 inPhraseOut: 
   63DD E6 85         [ 5]  413                     ldb      b,x                          ; load the next byte of our phrase 
   63DF E7 44         [ 5]  414                     stb      CURRENT_REG_BYTE,u           ; store that to current output 
   63E1 6C 4B         [ 7]  415                     inc      CURRENT_PLACE_IN_PHRASE,u    ; check if we are at the end of the phrase 
   63E3 A1 4B         [ 5]  416                     cmpa     CURRENT_PLACE_IN_PHRASE,u    ; (in a is phrase len) 
   63E5 26 09         [ 3]  417                     bne      currentPharseNotEnded        ; if phrase is not at end - continue 
   63E7 6F 4B         [ 7]  418                     clr      CURRENT_PLACE_IN_PHRASE,u    ; other wise we set place to zero 
   63E9 EC 45         [ 6]  419                     ldd      CURRENT_RLE_COUNTER,u        ; and decrease out RLE counter 
                            420  .globl not_in_phrase
   63EB                     421 not_in_phrase: 
   63EB 83 00 01      [ 4]  422                     subd     #1 
   63EE ED 45         [ 6]  423                     std      CURRENT_RLE_COUNTER,u 
                            424  .globl currentPharseNotEnded
   63F0                     425 currentPharseNotEnded: 
                            426  .globl done
   63F0                     427 done: 
                            428 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; was subroutine, now inlined-end
   63F0 E6 44         [ 5]  429                     ldb      CURRENT_REG_BYTE,u 
   63F2 A6 4E         [ 5]  430                     lda      REG_USED,u                   ; load current register 
                            431                                                           ; A PSG reg 
                            432                                                           ; B data 
   63F4 81 0D         [ 2]  433  cmpa #13
   63F6 26 04         [ 3]  434  bne no13
   63F8 C5 10         [ 2]  435  bitb #0x10
   63FA 26 16         [ 3]  436  bne doNotWriteReg13 ; if b part of phrase than 0xff, if single byte than 0x1f, indicator for envelope not changed
                            437  .globl no13
   63FC                     438 no13:
                            439 ; macro call ->                     WRITE_PSG  
   63FC 97 01         [ 4]  440                     STA      *VIA_port_a                  ;store register select byte 
   63FE 86 19         [ 2]  441                     LDA      #0x19                         ;sound BDIR on, BC1 on, mux off _ LATCH 
   6400 97 00         [ 4]  442                     STA      *VIA_port_b 
   6402 86 01         [ 2]  443                     LDA      #0x01                         ;sound BDIR off, BC1 off, mux off - INACTIVE 
   6404 97 00         [ 4]  444                     STA      *VIA_port_b 
   6406 96 01         [ 4]  445                     LDA      *VIA_port_a                  ;read sound chip status (?) 
   6408 D7 01         [ 4]  446                     STB      *VIA_port_a                  ;store data byte 
   640A C6 11         [ 2]  447                     LDB      #0x11                         ;sound BDIR on, BC1 off, mux off - WRITE 
   640C D7 00         [ 4]  448                     STB      *VIA_port_b 
   640E C6 01         [ 2]  449                     LDB      #0x01                         ;sound BDIR off, BC1 off, mux off - INACTIVE 
   6410 D7 00         [ 4]  450                     STB      *VIA_port_b 
                            451 
                            452 ;                    jsr      Sound_Byte                   ; and actually output that to the sound chip 
                            453  .globl doNotWriteReg13
   6412                     454 doNotWriteReg13:
   6412 33 C8 10      [ 5]  455                     leau     STRUCT_LEN,u                 ; go to next "register" of sound data 
   6415 7A C8 A0      [ 7]  456                     dec      _ym_regs_count                ; but only if we are not done yet, if counter is zero 
   6418 26 B7         [ 3]  457                     bne      next_reg                     ; we do not branch :-) 
                            458  .globl ymsodone
   641A                     459 ymsodone: 
   641A 39            [ 5]  460                     rts      
                            461 ;***************************************************************************
   ...
   641B                     465 noValidByte: 
                            466 ; no we must look at the bits
                            467 ; a will be our bit register
                            468 ; macro call ->                     read_one_bit_from_data  
                            469 ;;;;;;;;;;;; GET_BIT_START
   641B E6 42         [ 5]  470                     ldb      BIT_POS,u 
   641D 26 0C         [ 3]  471                     bne      bit_is_ready12 
                            472 ; load a new byte
   641F AE 40         [ 6]  473                     ldx      BYTE_POS,u 
   6421 E6 80         [ 6]  474                     ldb      ,x+ 
   6423 E7 43         [ 5]  475                     stb      CURRENT_DATA_BYTE,u 
   6425 AF 40         [ 6]  476                     stx      BYTE_POS,u 
   6427 C6 80         [ 2]  477                     ldb      #0x80 
   6429 E7 42         [ 5]  478                     stb      BIT_POS,u 
                            479  .globl bit_is_ready12
   642B                     480 bit_is_ready12: 
                            481 ; bit position correct here
                            482 ;
                            483 ; remember we use one bit now!
   642B 64 42         [ 7]  484                     lsr      BIT_POS,u 
                            485 ; is the bit at the current position set?
   642D E4 43         [ 5]  486                     andb     CURRENT_DATA_BYTE,u 
                            487 ;;;;;;;;;;;; GET_BIT_END
                            488 ; check bit, if 1 than RLE encoded
                            489 ; if not - not
   642F 10 26 FE 64   [ 6]  490                     lbne      rleEncodedData 
                            491                                                           ; must be zero 
                            492                                                           ; 1 is always only 8 bit... 
   6433 6C 46         [ 7]  493                     inc      CURRENT_RLE_COUNTER+1,u 
                            494  .globl dechifer
   6435                     495 dechifer: 
                            496 ; check bit
                            ...
                            500 ;;;;;;;;;;;; GET_BIT_START
   6435 E6 42         [ 5]  501                     ldb      BIT_POS,u 
   6437 26 0C         [ 3]  502                     bne      bit_is_ready13 
                            503 ; load a new byte
   6439 AE 40         [ 6]  504                     ldx      BYTE_POS,u 
   643B E6 80         [ 6]  505                     ldb      ,x+ 
   643D E7 43         [ 5]  506                     stb      CURRENT_DATA_BYTE,u 
   643F AF 40         [ 6]  507                     stx      BYTE_POS,u 
   6441 C6 80         [ 2]  508                     ldb      #0x80 
   6443 E7 42         [ 5]  509                     stb      BIT_POS,u 
                            510  .globl bit_is_ready13
   6445                     511 bit_is_ready13: 
                            512 ; bit position correct here
                            513 ;
                            514 ; remember we use one bit now!
   6445 64 42         [ 7]  515                     lsr      BIT_POS,u 
                            516 ; is the bit at the current position set?
   6447 E4 43         [ 5]  517                     andb     CURRENT_DATA_BYTE,u 
                            518 ;;;;;;;;;;;; GET_BIT_END
   6449 27 52         [ 3]  519                     beq      directByte                   ; if bit is zero - jump 
   644B 10 FF C8 94   [ 7]  520                     sts      _temp                         ; save stackpointer 
   644F 10 EE 47      [ 7]  521                     lds      REG_PHRASE_MAP,u             ; load the starting position of the phrase mappings for this register 
   6452 10 AE 4C      [ 7]  522                     ldy      PHRASE_DEFINITION_START,u    ; and also the phrase definition address 
   6455 4F            [ 2]  523                     clra                                  ; was _calc_bits, a contains the number of bits our current shannon code checkings 
   6456 B7 C8 97      [ 5]  524                     sta      _calc_coder                   ; starting with zero for coder also 
                            525  .globl getNextCodeBit
   6459                     526 getNextCodeBit: 
   6459 78 C8 97      [ 7]  527                     lsl      _calc_coder                   ; prepare load of next coder bit - shift all previous codes one position 
   645C 4C            [ 2]  528                     inca                                  ; increase used bits 
                            529 ; macro call ->                     read_one_bit_from_data  
                            530 ;;;;;;;;;;;; GET_BIT_START
   645D E6 42         [ 5]  531                     ldb      BIT_POS,u 
   645F 26 0C         [ 3]  532                     bne      bit_is_ready14 
                            533 ; load a new byte
   6461 AE 40         [ 6]  534                     ldx      BYTE_POS,u 
   6463 E6 80         [ 6]  535                     ldb      ,x+ 
   6465 E7 43         [ 5]  536                     stb      CURRENT_DATA_BYTE,u 
   6467 AF 40         [ 6]  537                     stx      BYTE_POS,u 
   6469 C6 80         [ 2]  538                     ldb      #0x80 
   646B E7 42         [ 5]  539                     stb      BIT_POS,u 
                            540  .globl bit_is_ready14
   646D                     541 bit_is_ready14: 
                            542 ; bit position correct here
                            543 ;
                            544 ; remember we use one bit now!
   646D 64 42         [ 7]  545                     lsr      BIT_POS,u 
                            546 ; is the bit at the current position set?
   646F E4 43         [ 5]  547                     andb     CURRENT_DATA_BYTE,u 
                            548 ;;;;;;;;;;;; GET_BIT_END
   6471 27 03         [ 3]  549                     beq      code_bit_notset              ; if bit is zero - jump 
   6473 7C C8 97      [ 7]  550                     inc      _calc_coder                   ; otherwise set bit in current code 
                            551  .globl code_bit_notset
   6476                     552 code_bit_notset: 
                            553  .globl testNextPhrase
   6476                     554 testNextPhrase: 
   6476 A1 E4         [ 4]  555                     cmpa     ,s                           ; check if it count of currently referenced phrase equals the current shannon bitcount 
   6478 2D DF         [ 3]  556                     blt      getNextCodeBit               ; if lower, load next bit (and increase shannon bits) 
   647A 27 08         [ 3]  557                     beq      bitLenFound                  ; if equal, than we must check if codes equal 
                            558 ; if greater, than we advance one in our phrase table, and check the next phrase
                            559  .globl increaseCodeBits
   647C                     560 increaseCodeBits: 
   647C E6 62         [ 5]  561                     ldb      2,s                          ; load length of last phase and 
   647E 31 A5         [ 5]  562                     leay     b,y                          ; add that to our future pointer to phrases 
   6480 32 63         [ 5]  563                     leas     3,s                          ; advance one phrase in out mapping (one mapping = 3 byte) 
   6482 20 F2         [ 3]  564                     bra      testNextPhrase               ; and test the next such got phrase 
                            565 
                            566 ; here we come if
   ...
   6484                     571 bitLenFound: 
   6484 E6 61         [ 5]  572                     ldb      1,s                          ; load coder-byte, from current phrase 
   6486 F1 C8 97      [ 5]  573                     cmpb     _calc_coder                   ; and compare with current loaded coder-byte from "bitstream" 
   6489 26 F1         [ 3]  574                     bne      increaseCodeBits             ; if not the same, check next phrase in phrase mapping (jump) 
   648B A6 62         [ 5]  575                     lda      2,s                          ; otherwise we found the correct phrase, load length of current phrase 
   648D A7 4F         [ 5]  576                     sta      CURRENT_PHRASE_LEN,u         ; and remember that 
   648F 10 FE C8 94   [ 7]  577                     lds      _temp                         ; restore stack 
   6493 1F 21         [ 6]  578                     tfr      y,x                          ; pointer to current found phrase to X (will be resused in out) 
   6495 5F            [ 2]  579                     clrb                                  ; current position in phrase is at start 0 
   6496 AF 49         [ 6]  580                     stx      CURRENT_IS_PHRASE,u          ; store the phrase to the structure 
   6498 E7 4B         [ 5]  581                     stb      CURRENT_PLACE_IN_PHRASE,u    ; also the position 
   649A 7E 63 DD      [ 4]  582                     jmp      inPhraseOut                  ; and output the next phrase byte 
                            583 
                            584 ; direct bytes are not shannon encoded 
                            585  .globl directByte
   649D                     586 directByte: 
                            587                                                           ; get 8 bit 
   649D EC 45         [ 6]  588                     ldd      CURRENT_RLE_COUNTER,u 
   649F 83 00 01      [ 4]  589                     subd     #1 
   64A2 ED 45         [ 6]  590                     std      CURRENT_RLE_COUNTER,u 
   64A4 4F            [ 2]  591                     clra     
   64A5 A7 49         [ 5]  592                     sta      CURRENT_IS_PHRASE,u 
   64A7 A7 4A         [ 5]  593                     sta      CURRENT_IS_PHRASE+1,u 
   ...
   64A9 8E 62 87      [ 3]  599                     ldx      #_reg_max_data 
   64AC E6 4E         [ 5]  600                     ldb      REG_USED,u 
   64AE E6 85         [ 5]  601                     ldb      b,x                          ; number of relevant bits for reg 
   64B0 C1 08         [ 2]  602                     cmpb     #8 
   64B2 27 0C         [ 3]  603                     beq      reg8Bits 
   64B4 C1 06         [ 2]  604                     cmpb     #6 
   64B6 27 38         [ 3]  605                     beq      reg6Bits 
   64B8 C1 05         [ 2]  606                     cmpb     #5 
   64BA 27 4C         [ 3]  607                     beq      reg5Bits 
   64BC C1 04         [ 2]  608                     cmpb     #4 
   64BE 27 60         [ 3]  609                     beq      reg4Bits 
                            610  .globl reg8Bits
   64C0                     611 reg8Bits: 
                            612 ; macro call ->                     read_one_bit_from_data  
                            613 ;;;;;;;;;;;; GET_BIT_START
   64C0 E6 42         [ 5]  614                     ldb      BIT_POS,u 
   64C2 26 0C         [ 3]  615                     bne      bit_is_ready15 
                            616 ; load a new byte
   64C4 AE 40         [ 6]  617                     ldx      BYTE_POS,u 
   64C6 E6 80         [ 6]  618                     ldb      ,x+ 
   64C8 E7 43         [ 5]  619                     stb      CURRENT_DATA_BYTE,u 
   64CA AF 40         [ 6]  620                     stx      BYTE_POS,u 
   64CC C6 80         [ 2]  621                     ldb      #0x80 
   64CE E7 42         [ 5]  622                     stb      BIT_POS,u 
                            623  .globl bit_is_ready15
   64D0                     624 bit_is_ready15: 
                            625 ; bit position correct here
                            626 ;
                            627 ; remember we use one bit now!
   64D0 64 42         [ 7]  628                     lsr      BIT_POS,u 
                            629 ; is the bit at the current position set?
   64D2 E4 43         [ 5]  630                     andb     CURRENT_DATA_BYTE,u 
                            631 ;;;;;;;;;;;; GET_BIT_END
   64D4 27 01         [ 3]  632                     beq      noBit1 
   64D6 4C            [ 2]  633                     inca     
                            634  .globl noBit1
   64D7                     635 noBit1: 
   64D7 48            [ 2]  636                     lsla     
                            ...
                            638 ;;;;;;;;;;;; GET_BIT_START
   64D8 E6 42         [ 5]  639                     ldb      BIT_POS,u 
   64DA 26 0C         [ 3]  640                     bne      bit_is_ready16 
                            641 ; load a new byte
   64DC AE 40         [ 6]  642                     ldx      BYTE_POS,u 
   64DE E6 80         [ 6]  643                     ldb      ,x+ 
   64E0 E7 43         [ 5]  644                     stb      CURRENT_DATA_BYTE,u 
   64E2 AF 40         [ 6]  645                     stx      BYTE_POS,u 
   64E4 C6 80         [ 2]  646                     ldb      #0x80 
   64E6 E7 42         [ 5]  647                     stb      BIT_POS,u 
                            648  .globl bit_is_ready16
   64E8                     649 bit_is_ready16: 
                            650 ; bit position correct here
                            651 ;
                            652 ; remember we use one bit now!
   64E8 64 42         [ 7]  653                     lsr      BIT_POS,u 
                            654 ; is the bit at the current position set?
   64EA E4 43         [ 5]  655                     andb     CURRENT_DATA_BYTE,u 
                            656 ;;;;;;;;;;;; GET_BIT_END
   64EC 27 01         [ 3]  657                     beq      noBit2 
   64EE 4C            [ 2]  658                     inca     
                            659  .globl noBit2
   64EF                     660 noBit2: 
   64EF 48            [ 2]  661                     lsla     
   ...
   64F0                     663 reg6Bits: 
                            ...
                            665 ;;;;;;;;;;;; GET_BIT_START
   64F0 E6 42         [ 5]  666                     ldb      BIT_POS,u 
   64F2 26 0C         [ 3]  667                     bne      bit_is_ready17 
                            668 ; load a new byte
   64F4 AE 40         [ 6]  669                     ldx      BYTE_POS,u 
   64F6 E6 80         [ 6]  670                     ldb      ,x+ 
   64F8 E7 43         [ 5]  671                     stb      CURRENT_DATA_BYTE,u 
   64FA AF 40         [ 6]  672                     stx      BYTE_POS,u 
   64FC C6 80         [ 2]  673                     ldb      #0x80 
   64FE E7 42         [ 5]  674                     stb      BIT_POS,u 
                            675  .globl bit_is_ready17
   6500                     676 bit_is_ready17: 
                            677 ; bit position correct here
                            678 ;
                            679 ; remember we use one bit now!
   6500 64 42         [ 7]  680                     lsr      BIT_POS,u 
                            681 ; is the bit at the current position set?
   6502 E4 43         [ 5]  682                     andb     CURRENT_DATA_BYTE,u 
                            683 ;;;;;;;;;;;; GET_BIT_END
   6504 27 01         [ 3]  684                     beq      noBit3 
   6506 4C            [ 2]  685                     inca     
                            686  .globl noBit3
   6507                     687 noBit3: 
   6507 48            [ 2]  688                     lsla     
   ...
   6508                     690 reg5Bits: 
                            ...
                            692 ;;;;;;;;;;;; GET_BIT_START
   6508 E6 42         [ 5]  693                     ldb      BIT_POS,u 
   650A 26 0C         [ 3]  694                     bne      bit_is_ready18 
                            695 ; load a new byte
   650C AE 40         [ 6]  696                     ldx      BYTE_POS,u 
   650E E6 80         [ 6]  697                     ldb      ,x+ 
   6510 E7 43         [ 5]  698                     stb      CURRENT_DATA_BYTE,u 
   6512 AF 40         [ 6]  699                     stx      BYTE_POS,u 
   6514 C6 80         [ 2]  700                     ldb      #0x80 
   6516 E7 42         [ 5]  701                     stb      BIT_POS,u 
                            702  .globl bit_is_ready18
   6518                     703 bit_is_ready18: 
                            704 ; bit position correct here
                            705 ;
                            706 ; remember we use one bit now!
   6518 64 42         [ 7]  707                     lsr      BIT_POS,u 
                            708 ; is the bit at the current position set?
   651A E4 43         [ 5]  709                     andb     CURRENT_DATA_BYTE,u 
                            710 ;;;;;;;;;;;; GET_BIT_END
   651C 27 01         [ 3]  711                     beq      noBit4 
   651E 4C            [ 2]  712                     inca     
                            713  .globl noBit4
   651F                     714 noBit4: 
   651F 48            [ 2]  715                     lsla     
   ...
   6520                     717 reg4Bits: 
                            ...
                            719 ;;;;;;;;;;;; GET_BIT_START
   6520 E6 42         [ 5]  720                     ldb      BIT_POS,u 
   6522 26 0C         [ 3]  721                     bne      bit_is_ready19 
                            722 ; load a new byte
   6524 AE 40         [ 6]  723                     ldx      BYTE_POS,u 
   6526 E6 80         [ 6]  724                     ldb      ,x+ 
   6528 E7 43         [ 5]  725                     stb      CURRENT_DATA_BYTE,u 
   652A AF 40         [ 6]  726                     stx      BYTE_POS,u 
   652C C6 80         [ 2]  727                     ldb      #0x80 
   652E E7 42         [ 5]  728                     stb      BIT_POS,u 
                            729  .globl bit_is_ready19
   6530                     730 bit_is_ready19: 
                            731 ; bit position correct here
                            732 ;
                            733 ; remember we use one bit now!
   6530 64 42         [ 7]  734                     lsr      BIT_POS,u 
                            735 ; is the bit at the current position set?
   6532 E4 43         [ 5]  736                     andb     CURRENT_DATA_BYTE,u 
                            737 ;;;;;;;;;;;; GET_BIT_END
   6534 27 01         [ 3]  738                     beq      noBit5 
   6536 4C            [ 2]  739                     inca     
                            740  .globl noBit5
   6537                     741 noBit5: 
   6537 48            [ 2]  742                     lsla     
                            ...
                            744 ;;;;;;;;;;;; GET_BIT_START
   6538 E6 42         [ 5]  745                     ldb      BIT_POS,u 
   653A 26 0C         [ 3]  746                     bne      bit_is_ready20 
                            747 ; load a new byte
   653C AE 40         [ 6]  748                     ldx      BYTE_POS,u 
   653E E6 80         [ 6]  749                     ldb      ,x+ 
   6540 E7 43         [ 5]  750                     stb      CURRENT_DATA_BYTE,u 
   6542 AF 40         [ 6]  751                     stx      BYTE_POS,u 
   6544 C6 80         [ 2]  752                     ldb      #0x80 
   6546 E7 42         [ 5]  753                     stb      BIT_POS,u 
                            754  .globl bit_is_ready20
   6548                     755 bit_is_ready20: 
                            756 ; bit position correct here
                            757 ;
                            758 ; remember we use one bit now!
   6548 64 42         [ 7]  759                     lsr      BIT_POS,u 
                            760 ; is the bit at the current position set?
   654A E4 43         [ 5]  761                     andb     CURRENT_DATA_BYTE,u 
                            762 ;;;;;;;;;;;; GET_BIT_END
   654C 27 01         [ 3]  763                     beq      noBit6 
   654E 4C            [ 2]  764                     inca     
                            765  .globl noBit6
   654F                     766 noBit6: 
   654F 48            [ 2]  767                     lsla     
                            ...
                            769 ;;;;;;;;;;;; GET_BIT_START
   6550 E6 42         [ 5]  770                     ldb      BIT_POS,u 
   6552 26 0C         [ 3]  771                     bne      bit_is_ready21 
                            772 ; load a new byte
   6554 AE 40         [ 6]  773                     ldx      BYTE_POS,u 
   6556 E6 80         [ 6]  774                     ldb      ,x+ 
   6558 E7 43         [ 5]  775                     stb      CURRENT_DATA_BYTE,u 
   655A AF 40         [ 6]  776                     stx      BYTE_POS,u 
   655C C6 80         [ 2]  777                     ldb      #0x80 
   655E E7 42         [ 5]  778                     stb      BIT_POS,u 
                            779  .globl bit_is_ready21
   6560                     780 bit_is_ready21: 
                            781 ; bit position correct here
                            782 ;
                            783 ; remember we use one bit now!
   6560 64 42         [ 7]  784                     lsr      BIT_POS,u 
                            785 ; is the bit at the current position set?
   6562 E4 43         [ 5]  786                     andb     CURRENT_DATA_BYTE,u 
                            787 ;;;;;;;;;;;; GET_BIT_END
   6564 27 01         [ 3]  788                     beq      noBit7 
   6566 4C            [ 2]  789                     inca     
                            790  .globl noBit7
   6567                     791 noBit7: 
   6567 48            [ 2]  792                     lsla     
                            ...
                            794 ;;;;;;;;;;;; GET_BIT_START
   6568 E6 42         [ 5]  795                     ldb      BIT_POS,u 
   656A 26 0C         [ 3]  796                     bne      bit_is_ready22 
                            797 ; load a new byte
   656C AE 40         [ 6]  798                     ldx      BYTE_POS,u 
   656E E6 80         [ 6]  799                     ldb      ,x+ 
   6570 E7 43         [ 5]  800                     stb      CURRENT_DATA_BYTE,u 
   6572 AF 40         [ 6]  801                     stx      BYTE_POS,u 
   6574 C6 80         [ 2]  802                     ldb      #0x80 
   6576 E7 42         [ 5]  803                     stb      BIT_POS,u 
                            804  .globl bit_is_ready22
   6578                     805 bit_is_ready22: 
                            806 ; bit position correct here
                            807 ;
                            808 ; remember we use one bit now!
   6578 64 42         [ 7]  809                     lsr      BIT_POS,u 
                            810 ; is the bit at the current position set?
   657A E4 43         [ 5]  811                     andb     CURRENT_DATA_BYTE,u 
                            812 ;;;;;;;;;;;; GET_BIT_END
   657C 27 01         [ 3]  813                     beq      noBit8 
   657E 4C            [ 2]  814                     inca     
                            815  .globl noBit8
   657F                     816 noBit8: 
   657F A7 44         [ 5]  817                     sta      CURRENT_REG_BYTE,u 
   6581 7E 63 F0      [ 4]  818                     jmp      done 
                            819 ;***************************************************************************
                            820 ;***************************************************************************
                            821  .globl init_ym_sound
   6584                     822 init_ym_sound: 
   6584 8E C8 A1      [ 3]  823                     ldx      #_ym_data_start               ; load start address of ram buffer for YM play 
   6587 CC 00 E0      [ 3]  824                     ldd      #(STRUCT_LEN*REGS_MAX)             ; load length of buffer 
   658A BD F5 48      [ 8]  825                     jsr      Clear_x_d                    ; clear buffer 
   658D 7F C8 9F      [ 7]  826                     clr      _ym_regs_used                 ; count of registers that are used by the player - reset 
   6590 10 AE C1      [ 9]  827                     ldy      ,u++                         ; first load start of all data to y 
   6593 EC A4         [ 5]  828                     ldd      ,y                           ; load vbl_len to d 
   6595 FD C8 99      [ 6]  829                     std      _ym_len                       ; and store it to len reset 
   6598 FD C8 9B      [ 6]  830                     std      _ym_data_current              ; and store it to current data pointer 
   659B E6 C0         [ 6]  831                     ldb      ,u+                          ; load number of next register to work on 
                            832  .globl nreg_init
   659D                     833 nreg_init: 
   659D 7C C8 9F      [ 7]  834                     inc      _ym_regs_used                 ; count the registers we actually use 
   65A0 E7 0E         [ 5]  835                     stb      REG_USED,x                   ; and store the register of the current data 
   65A2 10 AE C1      [ 9]  836                     ldy      ,u++                         ; load location of translation map to y 
   65A5 10 AF 07      [ 7]  837                     sty      REG_PHRASE_MAP,x             ; and store it 
   65A8 10 AE C1      [ 9]  838                     ldy      ,u++                         ; load location of phrases 
   65AB 10 AF 0C      [ 7]  839                     sty      PHRASE_DEFINITION_START,x    ; and store it 
   65AE 10 AE C1      [ 9]  840                     ldy      ,u++                         ; load location of RLE data 
   65B1 10 AF 00      [ 7]  841                     sty      BYTE_POS,x                   ; and store it 
   65B4 30 88 10      [ 5]  842                     leax     STRUCT_LEN,x                 ; add structure length to x 
   65B7 E6 C0         [ 6]  843                     ldb      ,u+                          ; load number of next register to work on 
   65B9 2A E2         [ 3]  844                     bpl      nreg_init                    ; if negative than we are done 
                            845  .globl regInitDone
   65BB                     846 regInitDone: 
   65BB FF C8 9D      [ 6]  847                     stu      _ym_name 
   65BE 39            [ 5]  848                     rts      
                            849 ;***************************************************************************
                            850 ;***************************************************************************
